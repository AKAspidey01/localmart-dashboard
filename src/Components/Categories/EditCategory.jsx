...
const EditCategory = () => {
      ...
      const receivedCategory = location?.state?.items;

      console.log(receivedCategory , "receivedCategory")
                 ...
                 <div className="inner-fields-grid-outer-main p-6 grid grid-cols-12 gap-5 items-center">  
                   <div className="category-add-name col-span-2">
                     ...
                     <div className="top-onclickprofile-pic  relative h-32 w-32 ">
                       ...
                       <img src={preview || receivedCategory?.icon} className='rounded-full absolute top-0 left-0 w-full object-contain border border-Black border-opacity-50' alt="" />
